...
const Education = () => {
  useGSAP(() => {
    // Loop through each education timeline card and animate them in
    ...
    // Animate the education timeline height as the user scrolls
        ...
        <div className="mt-32 relative">
          <div className="relative z-50 xl:space-y-32 space-y-10">
            {educationCards.map((card) => (
              <div key={card.degree} className="edu-card-wrapper">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="eduText flex xl:gap-20 md:gap-10 gap-5 relative z-20">
                      <div className="edu-timeline-logo">
                        <img src={card.logoPath} alt="education-logo" />
                      </div>
                      <div>
